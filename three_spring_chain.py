...
def integrate(ic, ti, p):
	m1, m2, k1, k2, k3, xeq1, xeq2 = p
	x1, v1, x2, v2 = ic

	print(ti)

	return [v1, A1.subs({M1:m1, K1:k1, K2:k2, Xeq1:xeq1, Xeq2:xeq2, X1:x1, X2:x2}),\
		v2, A2.subs({M2:m2, K2:k2, K3:k3, Xeq1:xeq1, Xeq2:xeq2, X1:x1, X2:x2})]


M1, M2, K1, K2, K3, Xeq1, Xeq2, t = sp.symbols('M1 M2 K1 K2 K3 Xeq1 Xeq2 t')
...
V = sp.Rational(1, 2) * (K1 * (X1 - Xeq1)**2 + K2 * ((X2 - Xeq2) - (X1 - Xeq1))**2 + K3 * (X2 - Xeq2)**2)
...
pe = np.asarray([V.subs({K1:k1, K2:k2, K3:k3, Xeq1:xeq1, Xeq2:xeq2, X1:xv[i,0], X2:xv[i,2]}) for i in range(nframes)])
E = ke + pe
